{{-- Here Navigation --}}
<nav x-data="{opened: false}" class="h-20 p-5 flex justify-between items-center relative z-50">
        ...
        <div 
            ...
            class="w-8 h-8 flex items-center border rounded-sm border-secondary-900 justify-center">
                <div x-show="!opened">
                        <x-menu-trigger  />
                </div>
                <span x-show="opened">
